...
class SettingsStore(
    ...
    companion object {
        ...
        val WORKSPACE_ROOT_MODE = booleanPreferencesKey("workspace_root_mode")
        val FLOATING_TASK_WINDOW = booleanPreferencesKey("floating_task_window")
...
data class Settings(
    ...
    val workspaceRootMode: Boolean = false,
    val floatingTaskWindowEnabled: Boolean = false,
