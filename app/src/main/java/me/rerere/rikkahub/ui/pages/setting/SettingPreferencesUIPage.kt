        ...
        LazyColumn(
            ...
            item {
                CardGroup(
                    ...
                    item(
                        headlineContent = { Text(stringResource(R.string.setting_display_page_enable_html_rendering_title)) },
                        supportingContent = { Text(stringResource(R.string.setting_display_page_enable_html_rendering_desc)) },
                        trailingContent = {
                            Switch(
                    ...
                    item(
                        headlineContent = { Text(stringResource(R.string.setting_display_page_user_persona_title)) },
                        supportingContent = {
                            Column {
                                Text(stringResource(R.string.setting_display_page_user_persona_desc))
                                OutlinedTextField(
