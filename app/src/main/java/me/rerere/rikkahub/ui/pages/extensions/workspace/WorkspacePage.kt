...
@Composable
fun WorkspacePage(vm: WorkspaceVM = koinViewModel(), settingVM: SettingVM = koinViewModel()) {
        ...
        LazyColumn(
            ...
            item {
                CardGroup {
                    item(
                        headlineContent = {
                            Text(stringResource(R.string.workspace_page_root_mode_title))
                        },
                        supportingContent = {
                            Text(stringResource(R.string.workspace_page_root_mode_desc))
                        },
                        trailingContent = {
                            Switch(
                                checked = settings.workspaceRootMode,
                                onCheckedChange = {
                                    settingVM.updateSettings(settings.copy(workspaceRootMode = it))
                                }
                            )
                        },
                    )
